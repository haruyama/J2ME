...
/**
 * XText is the XContent element child used to store character data. XText is
 * used to model both CDATA sections and normal character data.
 * 
 * @author Brian Frank
 * @creation 6 Apr 02
...
public final class XText extends XContent {
    ...
    /**
     * Get a direct reference to the character data buffer. Only the range of
     * characters from 0 to length()-1 are valid. Do not modify the buffer
     * directly, rather use the dedicated modification method.
     */
    public final char[] data() {
        ...
        char[] copyData = new char[data.length];
